...
Inventario de los recursos que forman parte del runtime actual. Fecha de revisión: 2026-09-13.

| Familia | Archivos usados | Autor / fuente | Licencia | Atribución |
| --- | --- | --- | --- | --- |
| Fondos del carrusel | `assets/art/backgrounds/*.png` | No consta en el repositorio | Pendiente de verificar | Pendiente |
| Icono del juego | `assets/art/branding/michi_td_icon.png` | Propio / no documentado | Pendiente de verificar | Pendiente |
...
| Kenney Cursor Pixel Pack | `assets/ui/cursors/*.png`, `assets/ui/icons/kenney_basic_double/*.png` | Kenney; https://www.kenney.nl/ | CC0 | Atribución opcional: Kenney / www.kenney.nl |
