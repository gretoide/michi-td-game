...
const EXTRA_CATALOG := {
    "en": {
        ...
        "game.wave": "Wave {number}", "game.pause": "Pause", "game.pause.title": "Game paused", "game.pause.message": "The game is paused.", "game.pause.resume": "Resume", "game.pause.main_menu": "Main menu", "game.pause.logout": "Log out", "game.pause.confirm_main_menu": "Return to main menu?", "game.pause.confirm_logout": "Log out?", "game.pause.confirm_message": "Your current construction will be abandoned.", "game.pause.confirm": "Continue", "game.pause.cancel": "Cancel", "game.resources.life": "Life", "game.resources.gold": "Gold", "game.resources.full": "Life {life}/{max_life} | Gold {gold} | XP {xp} | Quality {quality} | Progress {progress}", "game.resources.compact": "Life {life}/{max_life} · Gold {gold} · XP {xp} · Q {quality} · {progress}%",
        ...
        "game.selection.none": "Nothing selected", "game.selection.selected": "Selected: {kind}", "game.selection.gem": "Gem {id} | Level {level} | Quality {quality} | Cell {cell}", "game.selection.enemy": "Enemy {id} | HP {hp}/{max_hp} | Armor {armor} | MR {magic}", "game.selection.tower": "Tower {id} | Damage {damage} | Range {range} | Stopped: {stopped}", "game.selection.stone": "Stone selected", "game.feedback.help": "Click a cell to place or select a gem.", "game.feedback.place_hint": "Choose an empty cell on the map.", "game.feedback.select_hint": "Click a gem or enemy to inspect it.", "game.feedback.no_combination": "No valid combination for this selection.", "game.feedback.invalid_action": "This action is not available.",
        "game.recipes.title": "Known recipes", "game.recipes.color.all": "All colors", "game.recipes.color.blue": "Blue", "game.recipes.color.dark_blue": "Dark blue", "game.recipes.color.gold": "Gold", "game.recipes.color.light_green": "Green", "game.recipes.color.lilac": "Lilac", "game.recipes.color.purple": "Purple", "game.recipes.color.red": "Red", "game.recipes.color.turquoise": "Turquoise", "game.close": "Close", "game.reward.title": "Reward after wave {wave}", "game.end.victory": "Victory", "game.end.defeat": "Defeat", "game.end.score": "Final score: {score}", "game.restart": "Restart", "game.settings.title": "Settings", "game.settings.fullscreen": "Fullscreen", "game.settings.music_enabled": "Music on", "game.settings.music": "Music volume", "game.settings.sfx": "Effects volume", "game.settings.text_size": "Text size", "game.settings.text_small": "Small", "game.settings.text_normal": "Normal", "game.settings.text_large": "Large", "game.debug.title": "Debug information", "game.debug.info": "Seed: {seed}\nCatalog: {gems} gems · {recipes} recipes · {waves} waves",
        "game.harness.title": "Construction harness", "game.harness.select": "Select Gem", "game.harness.select_gem": "Select gem", "game.harness.place": "Place Gem", "game.harness.combine": "Combine basic", "game.harness.degrade": "Degrade", "game.harness.degrade_hint": "Select a non-Chipped gem", "game.harness.remove": "Remove Stone", "game.harness.status": "Gems {gems}/5 | Stones {stones} | Phase {phase}", "game.harness.rejected": "Rejected: {code}", "game.harness.finalized": "Construction finalized", "game.combat.summary": "Towers {towers} | Enemies {enemies} | Projectiles {projectiles}", "game.resources": "Life {life} | Gold {gold} | XP {xp} | Progress {progress}"
    },
    "es": {
        ...
        "game.wave": "Oleada {number}", "game.pause": "Pausa", "game.pause.title": "Partida pausada", "game.pause.message": "La partida está en pausa.", "game.pause.resume": "Continuar", "game.pause.main_menu": "Menú principal", "game.pause.logout": "Cerrar sesión", "game.pause.confirm_main_menu": "¿Volver al menú principal?", "game.pause.confirm_logout": "¿Cerrar sesión?", "game.pause.confirm_message": "La construcción actual se va a abandonar.", "game.pause.confirm": "Continuar", "game.pause.cancel": "Cancelar", "game.resources.life": "Vida", "game.resources.gold": "Oro", "game.resources.full": "Vida {life}/{max_life} | Oro {gold} | XP {xp} | Calidad {quality} | Progreso {progress}", "game.resources.compact": "Vida {life}/{max_life} · Oro {gold} · XP {xp} · C {quality} · {progress}%",
