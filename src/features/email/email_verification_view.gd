...
func setup(email: String) -> void:
    ...
    code_input = LineEdit.new(); code_input.alignment = HORIZONTAL_ALIGNMENT_CENTER; code_input.max_length = 6; code_input.custom_minimum_size = Vector2(0,48); code_input.add_theme_font_size_override("font_size", 22)
