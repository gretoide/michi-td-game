...
Los prototipos visuales de la partida usan el Fields tileset de CraftPix (licencia indicada en `assets`), gemas como unidades defensivas, proyectiles Pixel Fireball Pack de growmaster, hojas de enemigos felinos 3×4, personajes Tiny RPG Soldier/Orc (licencia del pack) y elementos de interfaz Pixel UI de Kenney (CC0). Se mantuvieron los PNG originales pixel-perfect.
